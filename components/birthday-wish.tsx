...
export default function BirthdayWish() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-pink">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">Happy Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-pink-600">Alisha Arshad</CardDescription>
            <p className="text-lg text-gray-500">August 2nd</p>
          </CardHeader>
